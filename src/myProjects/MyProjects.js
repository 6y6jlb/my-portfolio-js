                ...
                <div className={`${containerStyle.mainContainer} ${style.container}`}>
                    ...
                    <div className={style.projects}>
                        <MyProject propertie={'left'} style={divStylePortfolio} projectName={'Portfolio'} active={active} setActive={onFocusChange}
                                   description={' Current portfolio page is made on react using several libraries for animation and sass  '} link={'https://6y6jlb.github.io/my-portfolio-js/'}/>
                        <MyProject style={divStyleTodo} projectName={'To-Do'} active={active} setActive={onFocusChange} link={'https://github.com/6y6jlb/todolist'}
                                   description={' To-do project written entirely in type-script using Material UI library, redux, redux-thunk, axios etc. '}/>
                        <MyProject style={divStyleSN} projectName={'Social Network'} active={active} setActive={onFocusChange} link={'https://github.com/6y6jlb/social-nenwork-ts'}
                                   description={' The same type-script, almost the same technology stack as there, only without material-ui, just custom styles'}/>
                        <MyProject style={divStyleCounter} projectName={'Counter'} active={active} setActive={onFocusChange} link={'https://github.com/6y6jlb/counter-ts'}
